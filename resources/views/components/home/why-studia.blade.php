<section class="py-32 bg-white">
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 lg:gap-32 items-center">
            ...
            <div class="relative">
                <div class="absolute -inset-4 border-2 border-slate-100 rounded-[4rem] -rotate-3 z-0"></div>
                <div
                    class="relative z-10 bg-slate-900 p-12 lg:p-16 rounded-[4rem] text-white space-y-12 overflow-hidden shadow-2xl">
