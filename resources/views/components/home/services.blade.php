    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="flex flex-col lg:flex-row justify-between items-end gap-12 mb-24">
            <div class="max-w-2xl space-y-6">
                <h2 class="text-sm font-bold tracking-[0.3em] text-gold-600 uppercase italic">{{ __('services.firm_expertise') }}</h2>
                <h3 class="text-5xl lg:text-7xl font-black text-slate-900 leading-tight italic tracking-tighter">
                    {{ __('services.solutions_for') }} <br> <span class="text-gold-600">{{ __('services.seamless_mobility') }}</span>
                </h3>
            </div>
            <div class="pb-4">
                <p class="text-slate-500 font-medium max-w-sm italic">
                    {{ __('services.support_360') }}
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @php
                $services = [
                    [
                        'title' => __('services.academic_orientation'),
                        'desc' => __('services.academic_orientation_desc'),
                        'route' => 'services.orientation',
                        'icon' => 'M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z',
                        'color' => 'gold'
                    ],
                    [
                        'title' => __('services.international_admission'),
                        'desc' => __('services.international_admission_desc'),
                        'route' => 'services.abroad',
                        'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253',
                        'color' => 'slate'
                    ],
                    [
                        'title' => __('services.visa_procedure'),
                        'desc' => __('services.visa_procedure_desc'),
                        'route' => 'services.visa',
                        'icon' => 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
                        'color' => 'gold'
                    ],
                    [
                        'title' => __('services.departure_preparation'),
                        'desc' => __('services.departure_preparation_desc'),
                        'route' => 'services.departure',
                        'icon' => 'M12 19l9 2-9-18-9 18 9-2zm0 0v-8',
                        'color' => 'slate'
                    ],
                    [
                        'title' => __('services.housing_integration'),
                        'desc' => __('services.housing_integration_desc'),
                        'route' => 'housing',
